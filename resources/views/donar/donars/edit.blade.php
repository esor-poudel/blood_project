...
<div class="text-center"><h6>your last donation date is {{date('F j,Y',strtotime($donar->d_date))}} and mobile number= {{$donar->ph_number}}</h6></div>
<div class="text-center"><h4>update profile</h4></div>
<form id="create-channel-form" action="{{route('profile.store',['id'=>$donar->id])}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group row justify-content-center">
                          ...
                          <input onchange="document.getElementById('create-channel-form')" style="display: none" id="image" type="file" name="image">
